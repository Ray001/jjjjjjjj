...
if($typeCom == "airMail"){
	...
	/* $url ='http://api.kuaidi100.com/api?id=54b9a666dc7bc624&com='.$typeCom.'&nu='.$queryNo.'&show=2&muti=1&order=asc'; */
	...
	$powered = '该查询数据由：<a href="http://kuaidi100.com" target="_blank" ref="nofollow">KuaiDi100.Com （快递100）</a> 网站提供';
}
...
$smarty->assign('powered', $powered);
$smarty->assign('result', $get_content);
$smarty->display('gettrack.tpl');
